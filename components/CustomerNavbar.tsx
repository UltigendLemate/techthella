...
export default function CustomerHome() {
  ...
  return (
    <>
      <div>
        <nav className="relative border-gray-600 h-{104px} bg-[#231f20] ">
          <div className="flex flex-wrap h-[105px]  justify-between items-center self-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
          ...
          <div
            ...
            className={
              menuPricing
                ? "mt-1 shadow-sm  bg-[#191919] absolute top-[100px] w-full "
                : "hidden"
            }
          ...
          <div
            ...
            className={
              menuServices
                ? "mt-1 items-center  shadow-sm  absolute bg-[#231f20] w-full top-[100px]"
                : "hidden"
            }
